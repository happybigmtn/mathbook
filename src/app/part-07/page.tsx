...
export default function PartPage() {
  const chapters = getChaptersByPart("part-07")
    ...
    <div className="min-h-screen py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <h1 className="section-title">Influence of Mathematics</h1>
          <p className="body-text">The influence of mathematics on chemistry, biology, cryptography, economics, and more.</p>
        </motion.div>
