...
export default function PartPage() {
  const chapters = getChaptersByPart("part-04")
    ...
    <div className="min-h-screen py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <h1 className="section-title">Branches of Mathematics</h1>
          <p className="body-text">Deep dives into number theory, algebra, geometry, analysis, combinatorics, and more.</p>
        </motion.div>
