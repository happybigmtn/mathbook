...
export default function PartPage() {
  const chapters = getChaptersByPart("part-06")
    ...
    <div className="min-h-screen py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <h1 className="section-title">Mathematicians</h1>
          <p className="body-text">Biographies of the great mathematicians from Pythagoras to Turing.</p>
        </motion.div>
