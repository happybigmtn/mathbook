...
export default function PartPage() {
  const chapters = getChaptersByPart("part-02")
    ...
    <div className="min-h-screen py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <h1 className="section-title">Origins of Modern Mathematics</h1>
          <p className="body-text">From numbers to number systems, geometry, abstract algebra, algorithms, and the development of mathematical rigor.</p>
        </motion.div>
