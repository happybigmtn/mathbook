...
export default function PartPage() {
  const chapters = getChaptersByPart("part-05")
    ...
    <div className="min-h-screen py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <h1 className="section-title">Theorems and Problems</h1>
          <p className="body-text">The great theorems and open problems that drive mathematical research.</p>
        </motion.div>
