...
export default function PartPage() {
  const chapters = getChaptersByPart("part-03")
    ...
    <div className="min-h-screen py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <h1 className="section-title">Mathematical Concepts</h1>
          <p className="body-text">99 essential mathematical concepts from the Axiom of Choice to the Zermelo-Fraenkel Axioms.</p>
        </motion.div>
