...
occurred). It does this by applying a decoding function              to \infty. Our encoding function takes strings of length k to
...
Very informally, our goals are threefold. We would like              and let k → \infty, then (1 − p )k tends to 0 (exponentially
