...
VII.13.   Mathematics and Music                                                                                                 935
   ...
   Conscientious attempts to work out just how sci-          many of his successors—is the ultimate influence and
ence, even the parts concerned with theoretical enti-        legacy which the pioneers of analytic philosophy trans-
ties not directly observable (such as quarks and black       mitted from mathematics to their philosophical heirs.
...
methods gradually came to be better understood. Rus-         [VI.17](/part-06/christian-goldbach-16901764), suggests a serious connection between math-
sell’s theory of descriptions had been hailed by his         ematics and music, two subjects—one a science, the
student F. P. Ramsey as “a paradigm of philosophi-           other an art—that may at first seem very different from
...
pseudo-problems.                                             geometry, and astronomy. In the Pythagorean world-
   As analytic philosophy has developed, enthusiasm          view, these subjects were interlinked, since in one way
...
the writings of Continental philosophers (to say noth-       ment the monochord.1 Beginning with the Scientific
ing of the Continental iz ing philosophasters to be found
in certain humanities departments in universities in           1. The monochord was an instrument designed for demonstration,
...
appears in the section on melody in a monumental               cal sound, and particularly in the analysis of the inter-
treatise on music, entitled Harmonie universelle (1636–        vals between pairs of pitches. With the development
37), by the mathematician Marin Mersenne. Mersenne             of polyphonic music in the Renaissance period, the
applied simple (from today’s perspective) combinato-           Pythagorean conception of consonance based on the
rial techniques to the distribution and organization of        simple ratios of the integers from 1 to 4 eventually
notes in melodies. For example, he calculated the num-         came into conflict with musical practice. The acousti-
ber of different arrangements or permutations of n              cally pure perfect consonances of Pythagorean tuning
notes, for each n between 1 and 22 (twenty-two notes           were well-suited for medieval parallel organum,2 but in
delimiting the range of three octaves). The answer is of       the fifteenth and sixteenth centuries use was increas-
course n!, but in his zeal to illustrate this, he notated on   ingly made of the so-called imperfect consonances, that
musical staves all 720 (6!) permutations of the six notes      is, major and minor thirds and their octave inversions,
of the minor hexachord (A, B, C, D, E, F), occupying a         minor and major sixths. In Pythagorean tuning, inter-
full twelve pages of Harmonie universelle. He went on          vals are derived by successions of perfect fifths, so
to explore more complicated problems such as deter-            the corresponding frequency ratios are powers of 32 .
mining the number of melodies of a certain number              In conventional Western music, twelve perfect fifths in
of notes selected from a larger number, or determin-           succession, C–G–D–A–E–B–F* –C* –G* –D* –A* –E* –B* , are
ing the number of arrangements of finite collections            supposed to equal seven octaves (C = B* ), but this does
...
rial. Such exercises, while seemingly of little practical or   ference is a small interval known as the Pythagorean
                                                                                                               3
aesthetic value, at least demonstrated the great musi-         comma, which corresponds to a ratio of ( 2 )12 /27 ,
cal diversity that was in principle available with only a      which is about 1.013643.
limited set of resources.                                         Pythagorean tuning was originally conceived in terms
   The polymath Mersenne was a composer and practic-           of successive single pitches. The problems associated
ing musician as well as a mathematician, and his fas-          with it start to arise when pitches sound simultane-
cination with applying a relatively new mathematical           ously. While Pythagorean fifths between simultaneous
technique to music composition showed a level of inter-        pitches sound pleasing with their simple 3:2 ratios,
est in abstract connections between mathematics and            Pythagorean thirds and sixths have much more com-
music that is shared by many music theorists, and to a         plex ratios that sound harsh to Western ears. These
...
binatorial arguments, was used in the music theory of          motion to the plainchant melody at the interval of a perfect fourth or
...
equal parts has become fundamental. It means that                Figure 2 J. S. Bach, Well-Tempered Clavier, Book 2,
the notes used are naturally modeled by integers. If                    Fugue no. 9, subject and diminution.
...
the result of scientific discovery. Number and music           the twelve notes are arranged around the circle as a suc-
...
all powers of 2—and these relationships are reflected in       way, we see that C major is the key with no sharps or
the metric organization of musical time into bars with        flats, G major has one sharp, D major has two sharps,
the same number of beats. Bars or measures are indi-          A major has three sharps, etc. Similarly, moving coun-
...
are subdivided into three.                                    of integers mod 12, using the automorphism x → 7 x,
   A common device in musical composition, especially         and this makes some musical phenomena much more
counterpoint, is for a melodic theme, or subject, to          transparent.
reappear at half or twice the original speed, tech-              Reflective symmetry is another geometrical concept
niques known as rhythmic augmentation or diminu-              with a long history in musical composition. Musicians
tion, respectively. Figures 2 and 3 show the subjects         will frequently describe melodic lines in spatial terms,
of two fugues from the second volume of J. S. Bach’s          referring to notes of higher frequencies as “up,” and
Well-Tempered Clavier : no. 9 in E major, whose sub-          notes of lower frequencies as “down.” This allows one
...
theory is the circle of fifths, which was originally           of Bach’s Well-Tempered Clavier and a later appearance
designed to demonstrate the relationships between dif-        of the subject in inverted form. A geometrical reflection
ferent major and minor keys. As illustrated in figure 4,       is clearly visible in the notation, but, more importantly,

VII.13.   Mathematics and Music                                                                                    939
...
canon. Perhaps the best-known examples of cancrizans          of composers of different nationalities, such as Igor
occur in the music of J. S. Bach, such as in the first canon   Stravinsky, Olivier Messiaen, and Béla Bartók. The nov-
of The Musical Offering or the first and second canons          elty of the whole-tone and octatonic scales is that they
of the Goldberg Variations. Figure 6 shows the open-          have nontrivial translational symmetry, a property not
ing and closing measures of the cancrizans from Bach’s        shared by the major or minor scales. The whole-tone
Musical Offering. The melody of the first few bars of the       scale is unchanged if it is transposed by a tone, and
upper staff returns in reverse order at the end of the         the octatonic scale is unchanged if it is transposed by
piece in the lower staff, and likewise, the melody of the      a minor third. There are thus only two distinct trans-
first few bars of the lower staff returns in reverse order      lates of the whole-tone scale and three of the octa-
at the end of the upper staff. Joseph Haydn’s Menuetto         tonic scale. For this reason, neither scale has a clearly
al rovescio, from the Sonata no. 4 for violin and piano,      defined tonal center, which was a major reason for their
is another well-known example of a similar technique,         attractiveness to early twentieth-century composers.

940                                                                                        VII. The Influence of Mathematics

           Figure 6 J. S. Bach, The Musical Offering, opening and closing measures of the cancrizans (canon 1).

   Reflective symmetry was used by twentieth-century                                              E
...
of compositional design. A fascinating example is the
                                                                             F                                      C
first movement of Bartók’s Music for Strings, Percus-                    B                                                 G
sion, and Celesta (1936), which extends the traditional            E                                                           D
principles of the baroque fugue and incorporates a
                                                              A                                                                     A
symmetric design. Figure 7 illustrates the structure of
                                                                   D                                                            E
the fugue subject entries, starting from the initial entry                                                                B
                                                                         G
on A. In a traditional fugue, the subject is stated in                         C                                     F
tonic, followed by a statement in the dominant, and                                 F                           C
then again in the tonic (and continuing the alternat-                                       B             A
ing pattern of tonic and dominant entries for fugues                                                  E
with more than three voices). In Bartók’s fugue, the first      Figure 7 Plan of fugal entries in Béla Bartók’s Music
statement of the subject begins with the note A, and           for Strings, Percussion, and Celesta, first movement (after
the next with E. Instead of returning to A for the third       Morris (1994, p. 61), with permission).
statement, however, the subsequent entries follow a
pattern of alternating fifths in opposite directions from       general), the twelve notes are supposed to have equal
A: that is, the sequence A–E–B–F* , etc., alternates with      prominence: in particular, there is no single note with
the sequence A–D–G–C, etc. This pattern is illustrated in      a special status like that of the tonic in a major or
figure 7. Each of the interlocked cycles completes a cir-       minor key. The basic ingredient of a piece of twelve-
cle of fifths, one clockwise, the other counter clockwise.       tone music is a tone row, which is a sequence given
...
subsets of seven notes as one has in music in major or         one arranges the twelve notes in a circle, then one can also think of
minor keys. In twelve-tone music (and atonal music in          this translation as a rotation.

VII.13.   Mathematics and Music                                                                                       941
...
942                                                                                                   VII. The Influence of Mathematics
...
between lengths of formal divisions in music of Mozart,
                                                                                         8                                  4 E
Haydn, and others: they often use basic building blocks                        G = A
of four-measure phrases and use them in pairs, and
pairs of pairs, to form larger units. The techniques                                              7                 5
                                                                                             G               6          F
...
Fibonacci sequences and the golden ratio.                                   musical operations by means of transformations on
                                                                            this group, makes it much easier to analyze some kinds
         4    Mathematics and Music Theory                                  of music, such as the atonal music of Schoenberg, Berg,
In the second half of the twentieth century, the ideas                      and Webern, that do not lend themselves easily to more
of Schoenberg and his followers were extended and                           traditional analysis of harmony (see Forte 1973; Morris
developed in North American music theory. Milton Bab-                       1987; Straus 2005). This identification is illustrated in
bitt, a renowned American composer and theorist, is                         figure 9. As we have already commented, multiplying by
widely credited with introducing formal mathematics,                        5 or 7 is an automorphism of Z12 , and gives the cycle of
specifically group theory, to the theoretical study of                       fifths shown in figure 4 (when one substitutes the mod-
...
sound and their complex algorithmic processes.                              example, the major triad and the minor triad are related
...
ber and types of intervals. But while it seems reason-         musical works.
able enough to regard transposed chords as equivalent,            The level of generalization and abstraction makes
since they really do have an obvious “sameness” in             Lewin’s treatise a challenge for the mathematically
the way they sound, there has been some controversy            unsophisticated music theorist, but it does not need
over the notion of inversional equivalence. For exam-          more than fairly simple undergraduate-level algebra, so
ple, is it reasonable to declare major and minor triads        it is accessible enough for the determined reader with
to be equivalent to each other when they clearly do not        some mathematical training. It becomes clear to such a
sound the same and have very different musical roles?           reader that the formality of the presentation is essen-
Of course, we are free to define any equivalence relation       tial to a proper understanding of the transformation al
we like, so the real question is whether this one has any      approach to music theory and analysis. Despite this for-
utility. And in some contexts it does: with sets of notes      mality, Lewin continually maintains contact with music
...
Intervals and Transformations (1987), which develops           The playful Leibniz quotation with which this essay
a formal theory that connects mathematical reasoning           began underscores an enduring mathematical presence
