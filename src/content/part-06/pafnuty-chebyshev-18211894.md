...
of uniform convergence (introduced independently by
...
was differentiable except possibly at isolated points).                                                       Israel Kleiner
   Both riemann [VI.49] and Weierstrass (succeeding
Cauchy) founded complex function theory, but they
                                                            VI.45       Pafnuty Chebyshev
had fundamentally different approaches to the subject.
                                                            b. Okatovo, Russia, 1821; d. Saint Petersburg, Russia, 1894
Riemann’s global, geometric conception was based on         Assistant, Extraordinary then full Professor of Mathematics,
the notion of a riemann surface [III.79](/part-03/riemann-surfaces) and on the         Saint Petersburg (1847–82); Artillery Committee (1856);
                                                            Scientific Committee of the Ministry of Education (1856)
dirichlet principle [IV.12 §3.5](/part-04/analysis), while Weierstrass’s
local algebraic theory was grounded in power series
and analytic continuation [I.3 §5.6](/part-01/fundamental-definitions). “The more I           Fascinated by Watt’s parallelogram (the linkage used in
ponder the principles of function theory—and I do so        steam engines) and the problem of converting circular
incessantly—the more I am convinced that it must be         motion into rectilinear motion, Chebyshev embarked
founded on simple algebraic truths. . . ,” he asserted in   on a deep study of the theory of hinge mechanisms. In
a letter to H. A. Schwartz. He severely criticized the      particular, he sought the linkage that would produce
Dirichlet principle for being mathematically not well-      the minimum deviation from a straight line over a given
grounded, and produced a counterexample, after which        range. This corresponds to the mathematical problem
...
and results, among them the Weierstrass approximation       published in his memoir “Théorie des mécanismes con-
theorem, which says that a continuous function can be       nus sous le nom de parallélogrammes” (1854), and they
uniformly approximated by polynomials; the Bolzano–         marked the beginning of his important contributions to
Weierstrass theorem, which states that every infinite,       the theory of orthogonal polynomials.
bounded set of real numbers has a limit point; the            Chebyshev polynomials of the first kind are defined
Weierstrass factorization theorem, which gives the rep-     by Tn (cos θ) = cos(nθ), for n = 0, 1, 2, . . . . These poly-
resentation of an entire function in terms of an infinite    nomials also satisfy the recurrence relation Tn+1 (x) =
product of “prime functions”; the Casorati–Weierstrass      2 x Tn (2) − Tn−1 (x), where T0 (x) = 1 and T1 (x) =
theorem, which says that in every neighborhood of an        x. Chebyshev polynomials of the second kind satisfy
