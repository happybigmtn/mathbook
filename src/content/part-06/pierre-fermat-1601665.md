...
tained his “sign rule” about the number of positive and     cal and methodological aspects of the book were largely
negative roots of a polynomial, various transformation      ignored by his mathematical readers, but the technical
rules, and methods to check equations for reducibility.     mathematical aspects were eagerly accepted and used.
He gave no proofs; his results were based on a convic-
tion that polynomials could essentially be written as       Further Reading
products of linear factors x − xi , in which the roots xi   Bos, H. J. M. 2001. Redefining Geometrical Exactness: Des-
could be positive, negative, or “imaginary.”                  cartes’ Transformation of the Early Modern Concept of
   It appears, then, that analytic geometry was not the       Construction. New York: Springer.
primary goal of La Géométrie. Rather, its aim was to        Cottingham, J., ed. 1992. The Cambridge Companion to
provide a universal method for solving geometrical            Descartes. Cambridge: Cambridge University Press.
                                                            Shea, W. R. 1991. The Magic of Numbers and Motion: The
problems, and to do so Descartes had to answer two
                                                              Scientific Career of René Descartes. Canton, MA: Watson
urgent methodological questions. The first was how to
                                                              Publishing.
solve geometrical problems not constructible by ruler
                                                                                                         Henk J. M. Bos
and compass, and the second was how to use algebra
as an analytic, i.e., solution-finding, tool in geometry.
   For the first of these, Descartes allowed successively    VI.12      Pierre Fermat
                                                            b. Beaumont-de-Lomagne, France, 160?; d. Castres, France, 1665
more complicated curves as means of construction. It
                                                            Number theory; probability theory; variational principles;
was Descartes’s conviction that algebra, through the        quadrature; geometry
equations of these curves, could guide him to choose,
among all such construction curves, the most appro-         Fermat, who spent his life as a magistrate in the
priate for the problem, in particular the simplest, i.e.,   south of France, contributed decisively to most of the
that of lowest degree.                                      mathematical subjects of his time: from quadrature
   The second question addressed serious conceptual         to optics, from geometry to number theory. Very lit-
difficulties that were felt at the time about using alge-     tle is known about his early life—even the date of his
...
equations.                                                  manuscript Ad Locos Planos et Solidos Isagoge, which
