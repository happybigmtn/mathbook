...
750                                                                                                   VI. Mathematicians

in law, to devote himself to his personal passion,           [VI.19](/part-06/leonhard-euler-17071783) each independently coming to the conclusion
“géométrie” (that is, mathematics).                          that Newton’s theory of gravitation could not account
   D’Alembert’s first communications to the French            for the motion of the Moon. In 1747 d’Alembert dis-
Académie were concerned with the analytic geometry           cussed various possibilities for solving the problem—
of curves, the integral calculus, and fluid resistance,       an additional force, or a very irregular shape for the
notably the problem of the deceleration and deflec-           Moon, or some vortices between Earth and Moon—and
...
famous in learned circles. He built up a systematic and      Équinoxes (1749), Recherches sur Différents Points du
rigorous theory of mechanics founded upon a short            Système du Monde (1754–56), and in some of the eight
list of well-chosen principles—inertia, composition of       volumes of his Opuscules (1761–83).
motions (i.e., the addition of the effects of two forces or      In 1747 d’Alembert presented a paper on the famous
...
parallel slices. The essential idea behind the principle     with Euler and daniel bernoulli [VI.18](/part-06/the-bernoullis-) about the pos-
was to reduce a problem in dynamics to one in statics,       sible form of the solutions and the general notion of
roughly speaking by introducing a fictitious force, the       function.
“kinetic reaction,” which was minus the mass times the          D’Alembert’s work for the Encyclopédie (1751–65)
...
usual operations (addition, subtraction, multiplication,
                                                             Michel, A., and M. Paty. 2002. Analyse et Dynamique. Études
division, and exponentiation). He proved that, for a real      sur l’Oeuvre de d’Alembert. Laval, Québec: Les Presses de
polynomial, imaginary roots always occur in conjugate          l’Université Laval.
pairs, and that even if a real polynomial has no real                                               Francois de Gandt
root, there is still always a complex root. However, his
work was not rigorous—for example, he presupposed            VI.21      Edward Waring
the existence of roots—and consequently he did not           b. Shrewsbury, England, ca. 1735; d. Shrewsbury, 1798
provide a proof of the fundamental theorem of                Lucasian Professor of Mathematics, Cambridge (1760–98)
