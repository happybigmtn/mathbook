...
stop working and live off their savings. You can, of         Most of this Companion is rightly concerned with the
course, just live off the interest of your savings but       theories and practices of professional mathematicians.
this means that you will die with a large sum unspent.      But all human beings have ideas about numbers, space,
Alternatively, you can assume that you will live a cer-     and shape, and ways of putting these ideas to use. It
tain number of years and run down your savings, reach-      could be said that numeracy is to mathematics what lit-
ing zero at precisely the moment you expect to expire.      eracy is to literature: everyday, routine application ver-
...
of large numbers [III.71 §4](/part-03/probability-distributions), the corporation can be        developmental psychologies, and cover such diverse
...
In the past, mathematics has had a dramatic impact          developed world has tended to be studied by sociolo-
on physics and engineering. At one time this led            gists, but in the developing world by anthropologists;
to hopes that biological and sociological phenomena         historians of mathematics have mostly taken as their
would eventually come to be explained mathematically        subject the literate mathematics of the professional
...
984                                                                                            VIII. Final Perspectives

thinking in different ways. That is not to say that there       clearly derived from “eight tens.” But in all languages
are no constraints, however. Humans all share basic            number words also have social values attached, espe-
anatomical similarities that influence our ways of think-       cially the counting numbers and words for sets. This is
ing: we are approximately symmetrical about one verti-         a rather different phenomenon from mystical numerol-
...
and coinage. We shall return to Netz’s work later.             instance, has a variety of words for “group of three,”
   The examples in this essay have been selected from          each of which is applicable to a particular range of
...
be surprised, then, to discover the familiar as well as           That numbers have a “social life” was first recog-
the alien in the world’s oldest evidence for numeracy          nized by Gary Urton in his ethnographic study of the
and artisanal mathematics. By contrast, the cultures           Quechua-speaking inhabitants of the Bolivian Andes.
of the pre-Columbian Americas are important for their          Structurally, Quechua numeration is straightforward ly
very lack of contact with the premodern old world and          decimal, much like modern European number systems,
...
both South and North, in an attempt to break down              tification” on the other. There are also clear boundaries
the traditional disciplinary boundaries between past           around what may be counted and who may count them.
and present and between the developed world and the              All Quechua number words are composed of a dozen
developing world. Numeracy is a feature of all human           basic lexemes—one to ten, hundred, and thousand—
culture, wherever and whenever we have lived, and this         which may be combined additively or multiplicative ly,
should be reflected in how it is investigated.                  just as in English the word thirteen means “three and
...
Number words are usually studied for their mathemat-           for instance, kinsa means “three” and nothing else. But
ical content. French, for instance, shows traces of a          where synonyms for cardinal numbers are fairly rare in
vigesimal system in words such as quatre-vingts, mean-         English (one example is dozen for “twelve”), they are a
ing “four twenties,” while the English word eighty is          normal part of Quechua speech:
...
sequences, especially the names of the fingers, which          and unworldly. There were seven heavenly bodies (the
are themselves important everyday counting tools.             Sun, the Moon, five visible planets), seven books of the
Urton lists six very similar sets of names, attested over     Epic of Creation, and seven nights in each phase of the
the past 500 years. The most recent, collected by the         Moon. Demons, both beneficent and malevolent, were
Bolivian anthropologist Primitivo Nina Llanos in 1994,        said to operate in groups of seven.
goes as follows:                                                The Babylonians’ primary numerical base for count-
...
the antecedent of the others and the little finger the         ters were chosen in such a way that the tricky coprimes
...
as two symmetrical halves of a unified whole—as are              I found a stone; I did not weigh it. I added a seventh. I
paired items in general. In Quechua, one hand alone             added an eleventh. I weighed it: 1 mina. What was the
(or indeed an odd number) is not in its natural state.          original (weight of the) stone? The original stone was
                                                                2                      1
As Urton explains:                                              3 mina 8 shekels, 22 2 grains. (180 grains = 1 shekel;
                                                                60 shekel = 1 mina, ca. 0.5 kg.)
  [T]he motivation for two is the “loneliness” (ch’ulla) of
  one. “One” is an incomplete, alienated entity: it needs a      It is probably otiose to speculate whether the diffi-
