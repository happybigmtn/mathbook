...
elimination is a process of lower-triangular upper-          nentially small as a function of ρ as ρ → \infty, where n is
...
of (x T Ax)/(x T x) (for solving Ax = \lambda x if A is symmet-
...
A are favorably distributed. For example, it is often pos-    diverge at a rate as high as 2 n as n → \infty: the Runge
