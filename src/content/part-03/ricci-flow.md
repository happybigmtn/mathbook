...
In the Euclidean plane, this area would of course be $\pi r^{2}$ . In a Riemannian surface, this need not be the case: for instance, the total area of the surface of Earth (and hence of all disks within this surface) is finite, even though $\pi r^{2}$ can be arbitrarily large as r goes to infinity. However, we do require that, when r is very small, the area of the disk B (x , r) becomes increasingly close to $\pi r^{2}$ ; more precisely, we require that the ratio between the area and $\pi r^{2}$ converges to $1$ in the limit as r tends to $0$ .

III. Mathematical Concepts

This brings us to the notion of scalar curvature R (x). In some cases, such as on the sphere, the area | B (x , r) | of a small disk B (x , r) is actually a little bit smaller than $\pi r^{2}$ ; when this is the case, we say that the surface has positive scalar curvature at x. In some other cases, such as on a saddle, the area | B (x , r) | of a small disk B (x , r) is a bit larger than $\pi r^{2}$ ; then we say that the surface has negative scalar curvature at x.
In other cases again, such as on a cylinder, the area | B (x , r) | of a small disk B (x , r) is equal (or very nearly equal) to $\pi r^{2}$ ; in this case we say the surface has vanishing scalar curvature at x. (This is despite the cylinder being “curved” when viewed extrinsically as a subset of three dimensional space .) Note that on a complicated surface it is perfectly possible to have positive scalar curvature at some points of the surface and negative or vanishing scalar curvature at other points.
The scalar curvature R (x) at any given point x can be defined more precisely by the formula

$\pi r^{2} - |B(x$ , $r)|R(x) =$ lim / $\pi r^{4}/24r \to 0$
...
In Euclidean space, the area |A(x , $r$ , $\theta,v)|$ of this sec$1$ tor is ${}^{2}\theta r^{2}$ . But on a surface, the area |A(x , $r$ , $\theta,v)|$ may be slightly less (respectively , slightly more) than

$122\theta r$ . In these cases we say that the surface has positive (respectively , negative) Ricci curvature at x in the direction v. More precisely, we have

$1\theta r^{2} - |A(x$ , $r$ , $\theta,v)|$ Ric  (  x )(v , $v) =$ lim li$m^{2}$ .

$\theta r^{4}/24r \to 0\theta \to 0$
