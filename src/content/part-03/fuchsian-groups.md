...
moves some polygon around “en bloc” and there by tiles         sponding sides of the polygon are infinitely long with
...
bolic, just as that of the torus was locally Euclidean.       cedure might have been to name them after Schwarz,
   It turns out that if we carry out the above con struc-      and Poincaré was willing to agree once he read the rele-
...
son ably easy to see that the same construction can be         three-dimensional unit ball. The names have stuck ever
carried out. Indeed, if you just watch the original con-      since, but the study of Kleinian groups is much more
struc tion from an appropriate angle, instead of from          difficult and neither Poincaré nor Klein could do much