...
rank of the group E(K). For much more on the topic
of rational points on elliptic curves, see arithmetic
geometry [IV.5](/part-04/arithmetic-geometry).
   Since E(K) forms an Abelian group, given any prime
p one can look at the subgroup of elements P such
that p P = 0. This subgroup is called E(K)[p]. In par-
ticular, we can take the algebraic closure . ar{K} of K and
look at E(. ar{K})[p]. It turns out that, when K is a num-
...
theorem [V.10](/part-05/fermats-last-theorem) by Andrew Wiles is in the end a the-
...
tain group Λ of transformations. What is more, these
...
of elliptic functions [V.31](/part-05/the-riemannroch-theorem).) Each elliptic curve gives
...
completely honest, I should say that M1,1 is not quite a

191
curve at all—it is an object called, depending on whom
you ask, an orbifold [IV.4 §7](/part-04/algebra) or an algebraic stack—
you can think of it as a curve from which some one has
...
cult to visualize.) The curve M1,1 is a “simplest exam-
...
terms of 165 and 70 and conclude that
   5 = 3 × (165 − 2 . imes 70) − 70 = 3 . imes 165 − 7 . imes 70.
  This shows that 5 is the highest common factor
of 165 and 70 because any factor of 165 and 70 would
automatically be a factor of 3 . imes 165 − 7 . imes 70: that is, a
...
from the ratio 165/70 = 2.35714 . . . with out refer-
...
integer we can, 2, which tells us that q2 = 2. The recip-
4, so q4 = 4 and the continued fraction stops.
...
is π = 3.14159265 . . . , we start by subtracting 3, then
