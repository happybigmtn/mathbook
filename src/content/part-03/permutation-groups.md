...
gers contains either infinitely many odd numbers or             3 to 1; whereas the function c that sends 1 to 3, 2 to
...
which is an infinite set of axioms, one for each first-             If f and g are permutations of a set S, their composi-
...
countably many possible formulas p(x), whereas there           2. Notice that ab = ba.
