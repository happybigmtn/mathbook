...
events and issues in greater detail.
                                                                          higher infinite;
          1   Early Foundational Questions                          (iii) a preference “to put thoughts in the place of
                                                                          calculations” (Dirichlet), and to concentrate on
There is evidence that in 1899 Hilbert endorsed the                       “structures” characterized axiomatically; and
viewpoint that came to be known as logicism. Logicism               (iv) a frequent reliance on “purely existential” meth-
was the thesis that the basic concepts of mathemat-                       ods of proof.
ics are definable by means of logical notions, and that
the key principles of mathematics are deducible from                An early and influential example of these traits was
...
that set theory is just a part of (refined) logic,1 this the-        braic integers in terms of ideals, which are certain infi-
sis was thought to be supported by the fact that the                nite sets of algebraic integers. Using this new abstract
theories of natural and real numbers can be derived                 concept, together with a suitable definition of the
from set theory, and also by the increasingly important             product of two ideals, Dedekind was able to prove in
role of set-theoretic methods in algebra and in real and            full generality that, within any ring of algebraic inte-
complex analysis.                                                   gers, ideals possess a unique decomposition into prime
  Hilbert was following dedekind [VI.50](/part-06/julius-wilhelm-richard-dedekind-18311916) in the way                 ideals.
he understood mathematics. For us, the essence of                      The influential algebraist Kronecker complained that
Hilbert’s and Dedekind’s early logicism is their self-              Dedekind’s proofs do not enable us to calculate, in
conscious endorsement of certain modern methods,                    a particular case, the relevant divisors or ideals: that
however daring they seemed at the time. These meth-                 is, the proof was purely existential. Kronecker’s view
ods had emerged gradually during the nineteenth cen-                was that this abstract way of working, made possible
tury, and were particularly associated with Göttingen               by the set-theoretic methods and by a concentration
mathematics (gauss [VI.26](/part-06/carl-friedrich-gauss-17771855) and dirichlet [VI.36]);                  on the algebraic properties of the structures involved,
they experienced a crucial turning point with rie-                  was too remote from an algorithmic treatment—that is,
mann’s [VI.49] novel ideas, and were developed fur-                 from so-called constructive methods. But for Dedekind
ther by Dedekind, cantor [VI.54](/part-06/georg-cantor-18451918), Hilbert, and other,               this complaint was misguided: it merely showed that
lesser figures. Meanwhile, the influential Berlin school              he had succeeded in elaborating the principle “to put
of mathematics had opposed this new trend, kro-                     thoughts in the place of calculations,” a principle that
necker [VI.48](/part-06/leopold-kronecker-18231891) head-on and weierstrass [VI.44](/part-06/karl-weierstrass-18151897) more                 was also emphasized in Riemann’s theory of complex
subtly. (The name of Weierstrass is synonymous with                 functions. Obviously, concrete problems would require
the introduction of rigor in real analysis, but in fact, as         the development of more delicate computational tech-
will be indicated below, he did not favor the more mod-             niques, and Dedekind contributed to this in several
ern methods elaborated in his time.) Mathematicians in              papers. But he also insisted on the importance of a
...
showing the power and promise of the modern meth-            new doubts on its cogency. In around 1896, Cantor dis-
ods. During the 1890 s, the modern viewpoint in gen-          covered that the seemingly harmless concepts of the
eral, and logicism in particular, enjoyed great expan-       set of all ordinals and the set of all cardinals led to
sion. Hilbert developed the new methodology into the         contradictions. In the former case the contradiction
axiomatic method, which he used to good effect in his         is usually called the Burali-Forti paradox; the latter is
treatment of geometry (1899 and subsequent editions)         the Cantor paradox. The assumption that all transfi-
and of the real number system.                               nite ordinals form a set leads, by Cantor’s previous
   Then, dramatically, came the so-called logical para-      results, to the result that there is an ordinal that is less
doxes, discovered by Cantor, Russell, Zermelo, and oth-      than itself—and similarly for cardinals. Upon learning
ers, which will be discussed below. These were of two        of these paradoxes, Dedekind began to doubt whether
...
view of recent developments in mathematics that had          it should be said that only logicists were seriously
been proposed by logicism. Indeed, the heyday of logi-       upset by these arguments: they were presented with
cism came before the paradoxes, that is, before 1900;        contradictions in their theories.
it subsequently enjoyed a revival with Russell and his          Let us explain the importance of the Zermelo–Russell
“theory of types,” but by 1920 logicism was of inter-        paradox. From Riemann to Hilbert, many authors ac-
est more to philosophers than to mathematicians. How-        cepted the principle that, given any well-defined logi-
ever, the divide between advocates of the modern meth-       cal or mathematical property, there exists a set of all
ods and constructivist critics of these methods was          objects satisfying that property. In symbols: given a
there to stay.                                               well-defined property p, there exists another object,
                                                             the set {x : p(x)}. For example, corresponding to the
                   2   Around 1900                           property of “being a real number” (which is expressed
Hilbert opened his famous list of mathematical prob-         formally by Hilbert’s axioms) there is the set of all real
lems at the Paris International Congress of Mathematics      numbers; corresponding to the property of “being an
of 1900 with Cantor’s continuum problem [IV.22 §5](/part-04/set-theory),          ordinal” there is the set of all ordinals; and so on. This
a key question in set theory, and with the problem           is called the comprehension principle, and it constitutes
of whether every set can be well-ordered. His second         the basis for the logicistic understanding of set theory,
problem amounted to establishing the consistency of          often called naive set theory, although its naivete is
the notion of the set R of real numbers. It was not by       only clear with hindsight. The principle was thought
chance that he began with these problems: rather, it         of as a basic logical law, so that all of set theory was
was a way of making a clear statement about how math-        merely a part of elementary logic.
ematics should be in the twentieth century. Those two           The Zermelo–Russell paradox shows that the com-
problems, and the axiom of choice [III.1](/part-03/axiom-of-choice) employed           prehension principle is contradictory, and it does so
...
146                                                                             II. The Origins of Modern Mathematics

of R), and similarly, if R ∉ R, then R ∈ R. Hilbert (like   it introduces an element by reference to a totality that
his older colleague frege [VI.56](/part-06/gottlob-frege-18481925)) was led to abandon       already contains that element. A typical example is
...
that the corresponding axiom system is consistent—          relevant object can be specified only by reference to
that is, free of contradictions. The documentary evi-       the more embracing totality. Poincaré found examples
dence suggests that Hilbert came to this celebrated         of impredicative procedures in each of the paradoxes
principle in reaction to Cantor’s paradoxes. His rea-       he studied.
soning may have been that, instead of jumping directly         Take, for instance, Richard’s paradox, which is one
from well-defined concepts to their corresponding sets,      of the linguistic or semantic paradoxes (where, as we
one had first to prove that the concepts are logically       said, the notions of truth and definability are promi-
consistent. For example, before one could accept the set    nent). One begins with the idea of definable real num-
of all real numbers, one should prove the consistency       bers. Because definitions must be expressed in a certain
of Hilbert’s axiom system for them. Hilbert’s principle     language by finite expressions, there are only count-
was a way of removing any metaphysical content from         ably many definable numbers. Indeed, we can explic-
the notion of mathematical existence. This view, that       itly count the definable real numbers by listing them in
mathematical objects had a sort of “ideal existence” in     alphabetical order of their definitions. (This is known
the realm of thought rather than an independent meta-       as the lexicographic order.) Richard’s idea was to apply
physical existence, had been anticipated by Dedekind        to this list a diagonal process, of the kind used by Can-
and Cantor.                                                 tor to prove that R is not countable [III.11](/part-03/countable-and-uncountable-sets). Let the
   The “logical” paradoxes included not only the ones       definable numbers be a1 , a2 , a3 , . . . . Define a new num-
that go by the names of Burali-Forti, Cantor, and Rus-      ber r in a systematic way, making sure that the nth
sell, but also many semantic paradoxes formulated by        decimal digit of r is different from the nth decimal
Russell, Richard, König, Grelling, etc. (Richard’s para-    digit of an . (For example, let the nth digit of r be 2
...
gard the semantic paradoxes, and even formulate the         totality of all definable numbers.3
distinction between these and the set-theoretic ones.          In this kind of approach to the foundations of math-
                                                            ematics, all mathematical objects (beyond the natural
2.2   Predicativity                                         numbers) must be introduced by explicit definitions.
When the books of Frege and Russell made the para-          If a definition refers to a presumed totality of which
doxes of set theory widely known to the mathematical        the object being defined is itself a member, we are
community in 1903, poincaré [VI.61](/part-06/jules-henri-poincar-18541912) used them to put        involved in a circle: the object itself is then a con-
forward criticisms of both logicism and formalism.          stituent of its own definition. In this view, “definitions”
  His analysis of the paradoxes led him to coin an
important new notion, predicativity, and maintain that        3. The modern solution is to establish mathematical definitions
                                                            within a well-determined formal theory, whose language and expres-
impredicative definitions should be avoided in mathe-        sions are fixed to begin with. Richard’s paradox takes advantage of an
matics. Informally, a definition is impredicative when       ambiguity as to what the available means of definition are.
...
[VI.80](/part-06/hermann-weyl-18851955) accepted this point of view and developed it.                   were aimed at eliminating worries about impredicativ-
   Zermelo was not convinced, arguing that impredica-                   ity, and he tried to justify the other existence axioms
tive definitions were often used unproblematical ly, not                  of Principia—the axiom of infinity and the axiom of
...
insisted that these definitions are innocuous, because                   middle. (This, and Brouwer’s views, will be discussed in
the object being defined is not “created” by the defini-                  the next section.) However, the full system of the real
tion; it is merely singled out (see his paper of 1908 in                numbers was not available to him: in his system the set
van Heijenoort (1967, pp. 183–98)).                                     R was not complete and the Bolzano–Weierstrass theo-
   Poincaré’s idea of abolishing impredicative defini-                   rem failed, which meant that he had to devise sophisti-
tions became important for Russell, who incorporated                    cated replacements for the usual derivations of results
it as the “vicious circle principle” in his influential                  in analysis.
theory of types. Type theory is a system of higher-order                   The idea of predicative foundations for mathematics,
logic, with quantification over properties or sets, over                 in the style of Weyl, has been carefully developed in
relations, over sets of sets, and so on. Roughly speak-                 recent decades with noteworthy results (see Feferman
ing, it is based on the idea that the elements of any                   1998). Predicative systems lie between those that coun-
set should always be objects of a certain homogeneous                   tenance all of the modern methodology and the more
type. For instance, we can have sets of “individuals,”                  stringent constructivist ic systems. This is one of sev-
such as {a, b}, or sets of sets of individuals, such as                 eral foundational approaches that do not fit into the
{{a}, {a, b}}, but never a “mixed” set like {a, {a, b}}.                conventional but by now outdated triad of logicism,
Russell’s version of type theory became rather compli-                  formalism, and intuitionism.
cated because of the so-called ramification he adopted
                                                                        2.3   Choices
in order to avoid impredicativity. This system, together
with axioms of infinity, choice, and “reducibility” (a                   As important as the paradoxes were, their impact on
surprisingly ad hoc means to “collapse” the ramifica-                    the foundational debate has often been over stated. One
tion), sufficed for the development of set theory and the                 frequently finds accounts that take the paradoxes as
number systems. Thus it became the logical basis for                    the real starting point of the debate, in strong con-
the renowned Principia Mathematica by Whitehead and                     trast with our discussion in section 1. But even if we
Russell (1910–13), in which they carefully developed a                  restrict our attention to the first decade of the twenti-
foundation for mathematics.                                             eth century, there was another controversy of equal,
   Type theory remained the main logical system until                   if not greater, importance: the arguments that sur-
about 1930, but under the form of simple type theory                    rounded the axiom of choice and Zermelo’s proof of
                                                                        the well-ordering theorem.
                                                                           Recall from section 2.1 that the association between
  4. Cauchy’s reasoning was clearly nonconstructive, or “purely exis-
tential” as we have been saying. In order to show that the polynomial   sets and their defining properties was at the time
...
II.7.   The Crisis in the Foundations of Mathematics                                                              149
...
formalism and intuitionism.                                  that was much more radical than Weyl’s. In doing so, he
            ...
            3 The Crisis in a Strict Sense                   enticed Weyl and made him announce the coming of a
                                                             new age.
In 1921, the Mathematische Zeitschrift published a
paper by Weyl in which the famous mathematician, who         3.1   Intuitionism
...
and diagnosed a “crisis in the foundations” of math-
                                                             with two papers on “intuitionistic set theory,” writ-
ematics. The crisis pointed toward a “dissolution” of
                                                             ten in German and published in 1918 and 1919 by
the old state of analysis, by means of Brouwer’s “revo-
                                                             the Verhandelingen of the Dutch Academy of Sciences.
lution.” Weyl’s paper was meant as a propaganda pam-         These contributions were part of what he regarded as
...
ematics and Brouwer’s developing reconstruction of a         and proofs are of course organized logically, but their
much-reformed intuitionistic mathematics.                    basic principles (axioms) are grounded in intuition. But
   Why was Brouwer “revolutionary”? Up to 1920 the           Brouwer went beyond them and insisted on the abso-
key foundational issues had been the acceptability of        lute independence of mathematics from language and
the real numbers and, more fundamentally, of the             logic.
impredicativity and strong existential assumptions of           From 1907, Brouwer rejected the principle of the
set theory, which supported the higher infinite and           excluded middle (PEM), which he regarded as equiva-
the unrestricted use of existential proofs. Set theory       lent to Hilbert’s conviction that all mathematical prob-
and, by implication, classical analysis had been crit-       lems are solvable. PEM is the logical principle that the
icized for their reliance on impredicative definitions        statement p ∨ ¬p (that is, either p or not p) must
and for their strong existential assumptions (in par-        always be true, whatever the proposition p may be.
ticular, the axiom of choice, of which extensive use         (For example, it follows from PEM that either the deci-
was made by sierpiński [VI.77](/part-06/wacaw-sierpinski-18821969) in 1918). Thus, the          mal expansion of π contains infinitely many sevens or
debate in the first two decades of the twentieth cen-         it contains only finitely many sevens, even though we
tury was mainly about which principles to accept             do not have a proof of which.) Brouwer held that our
when it came to defining and establishing the exis-           customary logical principles were abstracted from the
tence of sets and subsets. A key question was, can           way we dealt with subsets of a finite set, and that it
one make rigorous the vague idea behind talk of “arbi-       was wrong to apply them to infinite sets as well. After
trary subsets”? The most coherent reactions had been         World War I he started the systematic reconstruction
Zermelo’s axiomatization of set theory and Weyl’s            of mathematics.
predicative system in Das Kontinuum. (The Principia             The intuitionist position is that one can only state “p
Mathematica of Whitehead and Russell was an unsuc-           or q” when one can give either a constructive proof of

150                                                                            II. The Origins of Modern Mathematics

p or a constructive proof of q. This standpoint has the       tal number [III.41](/part-03/irrational-and-transcendental-numbers). Since that date, it has been pos-
consequence that proofs by contradiction (reductio ad         sible to assign a truth value to statements that were
absurdum) are not valid. Consider Hilbert’s first proof        neither true nor false before, according to intuition-
of his basis theorem (section 1), achieved by reductio:       ists. This may seem paradoxical, but it was just right
he showed that one can derive a contradiction from the        for Brouwer, since in his view mathematical objects
assumption that the basis is infinite, and from this he        are mental constructions and he rejected as “meta-
concluded that the basis is finite. The logic behind this      physics” the assumption that they have an independent
procedure is that we start from a concrete instance of        existence.
PEM, p ∨ ¬p, show that ¬p is untenable, and conclude            In 1918, Brouwer replaced the sets of Cantor and
that p must be true. But constructive mathematics asks        Zermelo by constructive counterparts, which he would
for explicit procedures for constructing each object that     later call “spreads” and “species.” A species is basically
...
for the fundamental theorem of algebra.                       of mathematical constructions. Suppose, for example,
   It is easy to give instances of the use of PEM that a      that we wish to define a sequence of rational num-
constructivist will not accept: one just has to apply it      bers that gives better and better approximations to
to any unsolved mathematical problem. For example,            the square root of 2. In classical analysis, one con-
Catalan’s constant is the number
                                                              ceives of such sequences as existing in their entirety,
                         \infty
                               (−1)n                          but Brouwer defined a notion that he called a choice
                    K=                 .
                         n=0
                             (2 n + 1)2                        sequence, which pays more attention to how they might
It is not known whether K is transcendental, so if p is       be produced. One way to produce them is to give a rule,
                                                              such as the recurrence relation xn+1 = (xn    2 + 2)/2 x
the statement “Catalan’s constant is transcendental,”                                                                 n

then a constructivist will not accept that p is either true   (and the initial condition x1 = 2). But another is to
or false.                                                     make less rigidly determined choices that obey certain
   This may seem odd, or even obviously wrong, until          constraints: for instance, one might insist that xn has
                                                              denominator n and that xn     2 differs from 2 by at most
one realizes that constructivists have a different view
about what truth is. For a constructivist, to say that a      100/n, which does not determine xn uniquely but does
proposition is true simply means that we can prove it         ensure that the sequence produces better and better
                                                                                   √
in accordance with the stringent methods that we are          approximations to 2.
discussing; to say that it is false means that we can           A choice sequence is therefore not required to be
actually exhibit a counterexample to it. Since there is       completely specified from the outset, and it can involve
no reason to suppose that every existence statement           choices that are freely made by the mathematician at
has either a strict constructivist proof or an explicit       different moments in time. Both these features make
counterexample, there is no reason to believe PEM (with       choice sequences very different from the sequences
...
are constructed.6 For instance, one could take a spread                   for systems of analysis or set theory have never been
that consisted of all choice sequences that began in                      found.
some particular way, and such a spread would repre-                         Initially there had been hopes that the develop-
sent a segment—in general, spreads do not represent                       ment of intuitionism would end in a simple and ele-
isolated elements, but continuous domains. By using                       gant presentation of pure mathematics. However, as
spreads whose elements satisfy the Cauchy condition,                      Brouwer’s reconstruction developed in the 1920 s, it
Brouwer offered a new mathematical conception of the                       became more and more clear that intuitionistic analysis
continuum: rather than being made up of points (or real                   was extremely complicated and foreign. Brouwer was
numbers) with some previous Platonic existence, it was                    not worried, for, as he would say in 1933, “the spheres
...
defined a function to be an assignment of values to the                    after. Fortunately, there was an alternative approach
elements of a spread. However, because of the nature of                   that suggested another way of rehabilitating classical
spreads, this assignment had to be wholly dependent                       mathematics.
on an initial segment of the choice sequence in order
to be constructively admissible. This threw up a big                      3.2   Hilbert’s Program
surprise: all functions that are every where defined are
...
axioms [III.67](/part-03/the-peano-axioms) of arithmetic are consistent relative to
...
umph for the Hilbertians, though corresponding proofs
                                                                             Still, Hilbert’s ideas at the time were marred by a defi-
...
universal tree of natural numbers (consisting of all finite sequences of
natural numbers), together with an assignment of previously available       7. The logic he presented in 1905 lagged far behind Frege’s system
mathematical objects to the nodes. One law of the spread determines       of 1879 or Peano’s of the 1890 s. We do not enter into the development
nodes in the tree, the other maps them to objects.                        of logical theory in this period (see, for example, Moore 1998).

152                                                                                II. The Origins of Modern Mathematics

a refined understanding of logical theory and a greater         studied in any introduction to mathematical logic, such
awareness of the considerable technical difficulties of          as Dedekind–Peano arithmetic or Zermelo–Fraenkel set
his project. Other mathematicians played very signif-          theory. It turns out that first-order logic is enough for
icant parts in promoting this better understanding.            codifying mathematical proofs, but, interestingly, this
By 1921, helped by his assistant Bernays, Hilbert had          realization came rather late—after gödel’s theorems
arrived at a very refined conception of the formaliza-          [V.15](/part-05/gdels-theorem).
tion of mathematics, and had perceived the need for a             Hilbert’s main insight was that, when theories are
deeper and more careful probing into the logical struc-        formalized, any proof becomes a finite combinatorial
ture of mathematical proofs and theories. His program          object: it is just an array of strings of symbols com-
was first clearly formulated in a talk at Leipzig late in       plying with the formal rules of the system. As Bernays
1922.                                                          said, this was like “projecting” the deductive structure
   Here we will describe the mature form of Hilbert’s          of a theory T into the number-theoretic domain, and it
program, as it was presented for instance in the 1925          became possible to express in this domain the consis-
paper “On the infinite” (see van Heijenoort 1967). The          tency of T . These realizations raised hopes that a fini-
main goal was to establish, by means of syntactic con-         tary study of formalized proofs would suffice to estab-
sistency proofs, the logical acceptability of the princi-      lish the consistency of the theory, that is, to prove the
...
become possible to obtain precise results about their          the points in which his program of the 1920 s adopted
properties. The following steps are indispensable for          to some extent the principles of intuitionists such as
the completion of such a program.                              Poincaré and Brouwer and deviated strongly from the
                                                               ideas Hilbert himself had considered in 1900. The key
  (i) Finding suitable axioms and primitive concepts for       idea is that, contrary to the views of logicists like
      a mathematical theory T , such as that of the real       Frege and Dedekind, logic and pure thought require
...
In fact, steps (ii) and (iii) can be solved with rather sim-   doing so leads to the notion either of syntactic completeness or of
ple systems formalized in first-order logic, like those         semantic completeness.

II.7.   The Crisis in the Foundations of Mathematics                                                                               153

finitary consideration of signs that he took to be intu-                eccentric private life. He despised the modern world,
itively given. Finitary mathematics was not in need of                 looking to the inner life of the self as the only way
any further justification or reduction.                                 out (at least in principle, though not always in prac-
   Hilbert’s program proceeded gradually by studying                   tice). He preferred to work in isolation, although he had
weak theories at first and proceeding to progressively                  good friends in the mathematical community, espe-
stronger ones. The metatheory of a formal system stud-                 cially in the international group of topologists that
...
of 1929. For all of the 1920 s, the attention of Hilbert                   As a consequence of World War I, Germans in the
and coworkers was set on elementary arithmetic and its                 early 1920 s were not allowed to attend the Interna-
subsystems; once this had been settled, the project was                tional Congresses of Mathematicians. When the oppor-
to move on to the much more difficult, but crucial, cases                tunity finally arose in 1928, Hilbert was eager to seize
of the theory of real numbers and set theory. Acker-                   on it, but Brouwer was furious because of restrictions
mann and von Neumann were able to establish consis-                    that were still imposed on the German delegation and
tency results for certain subsystems of arithmetic, but                sent a circular letter in order to convince other math-
between 1928 and 1930 Hilbert was convinced that the                   ematicians. Their viewpoints were widely known and
consistency of arithmetic had already been established.                led to a clash between the two men. On another level,
Then came the severe blow of Gödel’s incompleteness                    Hilbert had made important concessions to his oppo-
results (see section 4).                                               nents in the 1920 s, hoping that he would succeed in
...
The crisis was unfolding not just at an intellectual level             decided it was imperative to remove Brouwer from the
but also at a personal level. One should perhaps tell                  editorial board. When he wrote to other members of the
...
edited by Rowe (1992), and also in the 1930 paper that bears exactly    11. See his “Intuitionistic reflections on formalism” of 1928 (in
the same title (see Gesammelte Abhandlungen, volume 3).                Mancosu 1998).

154                                                                                          II. The Origins of Modern Mathematics

action, and as a result of it the journal lost Einstein and                 According to what Gödel called at the time “the
Carathéodory, who had previously been main editors                       von Neumann conjecture” (namely, that if there is a
(see van Dalen 2005).                                                    finitary proof of consistency, then it can be formalized
  After that, Brouwer ceased to publish for some years,                  and codified within elementary arithmetic), the second
leaving some book plans unfinished. With his disap-                       theorem implies the failure of Hilbert’s program (see
pearance from the scene, and with the gradual disap-                     Mancosu (1999, p. 38) and, for more on the reception,
pearance of previous political turbulences, the feelings                 Dawson (1997, pp. 68 ff)). One should emphasize that
of “crisis” began to fade away (see Hesseling 2003).                     Gödel’s negative results are purely constructivist ic and
Hilbert did not intervene much in the subsequent                         even finitistic, valid for all parties in the foundational
debates and foundational developments.                                   debate. They were difficult to digest, but in the end
                                                                         they led to a reestablishment of the basic terms for
              4    Gödel and the Aftermath                               foundational studies.
...
mathematical community as a whole continued to work
                                                                         theory, with the rise of model theory [IV.23](/part-04/logic-and-model-theory), etc.—
in the style of modern mathematics. And yet his pro-
                                                                         all of which had their roots in the foundational stud-
gram suffered a profound blow with the publication
                                                                         ies of the first third of the twentieth century. Although
of Gödel’s famous 1931 article in the Monatshefte für
                                                                         the Zermelo–Fraenkel axioms suffice for giving a rig-
Mathematik und Physik. An extremely ingenious devel-
                                                                         orous foundation to most of today’s mathematics,
opment of met a mathematical methods—the arithme-
                                                                         and have a rather convincing intuitive justification in
tization of metamathematics—allowed Gödel to prove
...
[V.15](/part-05/gdels-theorem)). That is, there exist propositions P formulated
...
this first met a mathematical proof could itself be for-
                                                                         analysis can be formalized in conservative extensions
malized, which led to “Gödel’s second theorem”—that
...
codified within them. Gödel’s arithmetization of meta-
                                                                         that they have no new consequences in the language of
mathematics makes it possible to build a sentence, in
...
consistency of this same formal system. And this sen-
...
of intuitionism. One of the most important of these developments was the emergence of modern mathematical logic as a refinement of axiomatics, which led to the theories of recursion and computability in around 1936 ( see algorithms [II.4](/part-02/algorithms) ). In the process, our understanding of the characteristics, possibilities, and limitations of formal systems was hugely clarified. One of the hottest issues through out the whole debate, and probably its main source, was the question of how to understand the continuum. The reader may recall the contrast between the set-theoretic understanding of the real numbers and Brouwer’s approach, which rejected the idea that the continuum is “built of” points. That this is a labyrinthine question was further established by results on Cantor’s continuum hypothesis (CH), which postulates that the cardinality of the set of real numbers is א 1 , the second transfinite cardinal, or equivalently that every infinite subset of R must biject with either N or with R itself. Gödel proved in 1939 that CH is consistent with axiomatic set theory, but Paul Cohen proved in 1963 that it is independent of its axioms (i . e . , Cohen proved that the negation of CH is consistent with axiomatic set theory [IV.22](/part-04/set-theory)). The problem is still alive, with a few mathematicians proposing alternative approaches to the continuum and others trying to find new and convincing set-theoretic principles that will settle Cantor’s question (see Woodin 2001 ). The foundational debate has also contributed in a definitive way to clarifying the peculiar style and methodology of modern mathematics, especially the so-called Platonism or existential character of modern mathematics (see the classic 1935 paper of Bernays in Benacerraf and Putnam ( 1983 )), by which is meant (here at least) a methodological trait rather than any supposed implications of metaphysical existence. Modern mathematics investigates structures by considering their elements as given independently of human (or mechanical) capabilities of effective definition and construction. This may seem surprising, but perhaps this trait can be explained by broader characteristics of scientific thought and the role played by mathematical structures in the modeling of scientific phenomena. In the end, the debate made it clear that mathematics and its modern methods are still surrounded by important philosophical problems. When a sizable amount of mathematical knowledge can be taken for granted, theorems can be established and problems can be solved with the certainty and clarity for which mathematics is celebrated. But when it comes to laying out the bare

156                                                                            II. The Origins of Modern Mathematics

beginnings, philosophical issues cannot be avoided.           Hesseling, D. E. 2003. Gnomes in the Fog: The Reception of
The reader of these pages may have felt this at several         Brouwer’s Intuitionism in the 1920 s. Basel: Birkhäuser.
places, especially in the discussion of intuitionism, but     Heyting, A. 1956. Intuitionism: An Introduction. Amsterdam:
...
for their helpful comments on a previous version of this
                                                              Mehrtens, H. 1990. Moderne—Sprache—Mathematik. Frank-
paper.
                                                                furt: Suhrkamp.
...
by Bernays, Brouwer, Cantor, Dedekind, Gödel, Hilbert,
                                                                Routledge.
Kronecker, von Neumann, Poincaré, Russell, Weyl, Zer-         Rowe, D. 1992. Natur und mathematisches Erkennen. Basel:
melo, etc. The reader can easily find them in the source         Birkhäuser.
books by van Heijenoort (1967), Benacerraf and Putnam         Sieg, W. 1999. Hilbert’s programs: 1917–1922. The Bulletin
(1983), Heinzmann (1986), Ewald (1996), and Mancosu             of Symbolic Logic 5:1–44.
(1998).                                                       Smullyan, R. 2001. Gödel’s Incompleteness Theorems. Ox-
                                                                ford: Oxford University Press.
Benacerraf, P., and H. Putnam, eds. 1983. Philosophy of       Tait, W. W. 1981. Finitism. Journal of Philosophy 78:524–46.
  Mathematics: Selected Readings. Cambridge: Cambridge        van Atten, M. 2003. On Brouwer. Belmont, CA: Wadsworth.
  University Press.                                           van Dalen, D. 1999/2005. Mystic, Geometer, and Intuitionist:
Dawson Jr., J. W. 1997. Logical Dilemmas: The Life and Work     The Life of L. E. J. Brouwer. Volume I: The Dawning Rev-
  of Kurt Gödel. Wellesley, MA: A. K. Peters.                   olution. Volume II: Hope and Disillusion. Oxford: Oxford
Ewald, W., ed. 1996. From Kant to Hilbert: A Source Book in     University Press.
  the Foundations of Mathematics, 2 vols. Oxford: Oxford      van Heijenoort, J., ed. 1967. From Frege to Gödel: A Source
  University Press.                                             Book in Mathematical Logic. Cambridge, MA: Harvard
Feferman, S. 1998. In the Light of Logic. Oxford: Oxford        University Press. (Reprinted, 2002.)
  University Press.                                           Weyl, H. 1918. Das Kontinuum. Leipzig: Veit.
Ferreirós, J. 1999. Labyrinth of Thought: A History of Set    Whitehead, N. R., and B. Russell. 1910/13. Principia Math-
  Theory and Its Role in Modern Mathematics. Basel: Birk-       ematica. Cambridge: Cambridge University Press. Second
  häuser.                                                       edition 1925/27. (Reprinted, 1978.)
Heinzmann, G., ed. 1986. Poincaré, Russell, Zermelo et        Woodin, W. H. 2001. The continuum hypothesis, I, II. Notices
  Peano. Paris: Vrin.                                           of the American Mathematical Society 48:567–76, 681–90.
