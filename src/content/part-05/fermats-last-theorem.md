...
deduce that
        ...
        N−M→\infty N − M                                               A. Brunel. De Gruyter Studies in Mathematics, volume 6.
                    n=M
...
one has
           ...
           lim       f (T n x) =       =      .
           N→\infty N                 μ(X)    μ(X)                   that it was not possible, and that he had a proof that
                 n=0
